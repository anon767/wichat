...
public class InputThread extends Thread {
     ...
     */
    InputThread(com.example.tom.wichatv2.Backend.Protocol.IRC.API.IRCClient bot, Socket socket, BufferedReader breader, BufferedWriter bwriter) {
        _bot = bot;
        _socket = socket;
        _breader = breader;
        _bwriter = bwriter;
    ...
    private com.example.tom.wichatv2.Backend.Protocol.IRC.API.IRCClient _bot = null;
